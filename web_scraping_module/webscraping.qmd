...
I decided to use the rvest package for webscraping. I was introduced to it through TidyTuesday. For politeness sake, I am working on a downloaded copy of the webpage.
...
matched_records <- rev_war_test %>% inner_join(tombstones2, by = c("match_1" = "full_name"))
