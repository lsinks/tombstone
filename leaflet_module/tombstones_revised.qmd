...
I'm adding some jitter to the coordinates with [`sf_jitter()`](https://r-spatial.github.io/sf/reference/st_jitter.html); tombstones that are very close to each other have the same coordinates and show up as overlapping on the map.
...
tombstones_geo <- st_jitter(tombstones_geo, amount = 5)
```
